function Salesforce_Visa_ELEC_OOP()
{
  ...
  if (closedSearchBox.Exists)
  {
    ...
    if (activeInputBox.Exists)
    {
      ...
      if (accountLink.Exists)
      {
        ...
        var paymentMethodXPath = "//*[text()='Receipt Payment Method']/ancestor::*[self::div or self::slot or contains(@class,'item')]//*[text()='VISA'] | //*[text()='Receipt Payment Method']/following::*[contains(@class, 'value') or @role='gridcell']//*[text()]";
        if (!page.FindElement(paymentMethodXPath).Exists) {
            paymentMethodXPath = "//*[text()='VISA']";
        }
        ...
        if (paymentMethodField.Exists) {
            ...
            var expectedPaymentMethod = "VISA"; 
