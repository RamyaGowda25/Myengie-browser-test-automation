function Salesforce_MC_ELEC_OOP()
{
 
  let browser = Sys.Browser("chrome");
  let page = browser.Page("*simplyenergy--preprod.sandbox*");
  var accountNumber =Project.Variables.ElectricityAccountNumber;
    ...
    if (activeInputBox.Exists)
    {
      ...
      if (accountLink.Exists)
      {
        ...
        if (typeof activeAccountNumber === "undefined" || activeAccountNumber === "") {
            activeAccountNumber = Project.Variables.ElectricityAccountNumber;
        }
        ...
        var paymentMethodXPath = "//*[text()='Receipt Payment Method']/ancestor::*[self::div or self::slot or contains(@class,'item')]//*[text()='Mastercard'] | //*[text()='Receipt Payment Method']/following::*[contains(@class, 'value') or @role='gridcell']//*[text()]";
        if (!page.FindElement(paymentMethodXPath).Exists) {
            paymentMethodXPath = "//*[text()='Mastercard']";
        }
        ...
        if (paymentMethodField.Exists) {
            ...
            var expectedPaymentMethod = "Mastercard"; 
