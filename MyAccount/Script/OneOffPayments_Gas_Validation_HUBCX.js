function OneOffPayment_Gas_validation_HUBCX() {
    ...
    let targetAccountNumber = Project.Variables.GasAccountNumber; 
    ...
    if (paymentMethodElement.Exists) {
        ...
        if (capturedMethodText !== "") {
            ...
            if (isValid) {
                ...
                Log.Error("FAILED: Checkpoint boundary mismatch. The captured method '" + capturedMethodText + "' does not belong to the allowed list: [Paypal, VISA, MASTER, AMEX]");
            }
